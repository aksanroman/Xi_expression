...
lcl_expressed <- tpm1_genes_xx_xy_median(tximport_file = txi_myCell,XX_samples = XX_sample_names, XY_samples = XY_sample_names )
...
myCell_expressed <- lcl_expressed
...
## START HERE WITH PROCESSED NORMALIZED COUNTS DATA
#Example with LCLs
normCounts_expYgenes <- read.delim(file=paste0(myPath,"Linear_regressions/LCLs/LCL_normCounts_expYgenes_male.txt"), stringsAsFactors = FALSE, check.names = FALSE)
normCounts_expYgenes_all <- read.delim(file=paste0(myPath,"Linear_regressions/LCLs/LCL_normCounts_expYgenes_all.txt"), stringsAsFactors = FALSE, check.names = FALSE)
